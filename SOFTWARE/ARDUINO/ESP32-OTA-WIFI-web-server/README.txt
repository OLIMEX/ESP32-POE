...
Make sure the exact board is selected in Arduino IDE and proper COM then load the ota-server.ino and then Upload it to the board. Check the serial for web-page address and go to the address /upload.
