...
$EndComp
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG04
U 1 1 580DC57F
P 3000 1200
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:SY8009AAAC(SOT23-5) U7
U 1 1 580E129E
P 7600 3300
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG08
U 1 1 580E51FE
P 8900 3000
...
Power Supply
$Comp
L ESP32-PoE_Rev_E:SIDE_WTCM-TR(3x4) BUT1
U 1 1 580F02B2
P 19700 1700
...
UEXT
$Comp
L ESP32-PoE_Rev_E:D_Schottky D3
U 1 1 581010C5
P 7000 2150
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:P-MOS+DIOD FET2
U 1 1 5813E337
P 6600 2200
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:BAT_CON BAT1
U 1 1 581425A7
P 6600 3550
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:LAN8710A-EZC(QFN32) U4
U 1 1 58160809
P 6500 8000
...
ESP-WROOM-32 MODULE
$Comp
L ESP32-PoE_Rev_E:RA1206_(4x0603)_4B8_Smashed RM3
U 2 1 581E802F
P 19700 3550
...
GPIO5\SPI_CS
$Comp
L ESP32-PoE_Rev_E:D_Schottky_Small D4
U 1 1 5825D356
P 20900 10700
...
Extensions
$Comp
L ESP32-PoE_Rev_E:RA1206_(4x0603)_4B8_Smashed RM1
U 2 1 5818206D
P 7700 7950
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:RA1206_(4x0603)_4B8_Smashed RM2
U 3 1 58182428
P 7700 8550
...
GPIO21\EMAC_TX_EN(RMII)
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG06
U 1 1 58211FD0
P 4100 7100
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG07
U 1 1 582123AC
P 5500 6900
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG09
U 1 1 58216434
P 21500 3700
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:USB-MINI USB-UART1
U 1 1 58D440A7
P 1200 13800
...
+5V_USB
$Comp
L ESP32-PoE_Rev_E:P-MOS+DIOD FET1
U 1 1 58D9F018
P 2200 1800
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:D_Schottky D1
U 1 1 58DA405C
P 2150 2200
...
GPIO3\U0RXD
$Comp
L ESP32-PoE_Rev_E:Q_NPN_BEC Q2
U 1 1 58D6B1BC
P 6600 13700
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:Q_NPN_BEC Q3
U 1 1 58D74BC0
P 6600 14400
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:SIDE_WTCM-TR(3x4) RST1
U 1 1 580F1A95
P 19700 2300
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:ESP-WROOM-32 U9
U 1 1 5821F429
P 13300 3400
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:BAT54C(SOT23-3) D2
U 1 1 58F77BD8
P 8200 14900
...
$Comp
L ESP32-PoE_Rev_E:RJP-003TC1(LPJ4112CNL) LAN_CON1
U 1 1 5B205EE4
P 1900 9100
...
Wire Wire Line
	4100 9300 4100 9400
$Comp
L ESP32-PoE_Rev_E:Si3402-B-GM(QFN-20_5x5mm) U8
U 1 1 5AE0CC1A
P 12700 9200
...
$Comp
L ESP32-PoE_Rev_E:Earth #PWR052
U 1 1 5B271686
P 10300 10000
...
Text Notes 10700 8300 0    70   ~ 14
Vss
Text Notes 10700 9900 0    70   ~ 14
Vneg
...
Wire Wire Line
	2900 9700 3300 9700
Text Notes 10700 7900 0    70   ~ 14
Vpos
Text Notes 10700 9000 0    70   ~ 14
Vss
$Comp
L ESP32-PoE_Rev_E:Earth #PWR023
U 1 1 5F12A4A0
P 4100 10000
...
F 3 "" H 4100 10000 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text Notes 15600 9100 0    50   ~ 10
VOUT=1.35*(1+Ra/Rb)
Text Notes 15875 8525 0    50   ~ 10
Ra
Text Notes 15875 8025 0    50   ~ 10
Rb
Text GLabel 14800 9600 2    50   Input ~ 10
Spare1
Text GLabel 14800 9700 2    50   Input ~ 10
Spare2
Wire Wire Line
...
Wire Wire Line
	3000 2200 3000 3300
Text Notes 13625 8300 1    30   ~ 6
RDET
Text Notes 10275 9175 1    30   ~ 6
CDET
Text Notes 11725 9625 2    30   ~ 6
Rclass
Text Notes 10700 9450 0    60   ~ 12
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:MICRO_SD(TFC-9P-1.xH(ATFFS150A01BR016)) MICRO_SD1
U 1 1 5AE6629D
P 22200 4400
...
NoConn ~ 21900 4800
$Comp
L ESP32-PoE_Rev_E:Fiducial FID1
U 1 1 5AF57B2C
P 19000 13700
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:Fiducial FID2
U 1 1 5AF5872D
P 20400 13700
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:Fiducial FID3
U 1 1 5AFC6F83
P 21800 13700
...
Wire Wire Line
	2200 3700 2200 4100
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG03
U 1 1 5BED7AE8
P 2200 3700
...
GPIO12\PHY_PWR
$Comp
L ESP32-PoE_Rev_E:P-MOS+DIOD FET3
U 1 1 5C017824
P 2000 6400
...
Wire Wire Line
	1900 6650 1900 6800
$Comp
L ESP32-PoE_Rev_E:DTC114YKA(SOT-23) T1
U 1 1 5C315CE1
P 2000 7700
...
Wire Wire Line
	1900 6800 1900 7000
$Comp
L ESP32-PoE_Rev_E:+3.3VLAN #PWR0102
U 1 1 5CADAAFE
P 3500 6500
...
Wire Wire Line
	3500 6500 3500 6700
$Comp
L ESP32-PoE_Rev_E:+3.3VLAN #PWR0103
U 1 1 5CB32987
P 8900 7300
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:+3.3VLAN #PWR0104
U 1 1 5CD98449
P 8900 8600
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:+3.3VLAN #PWR0105
U 1 1 5CD98A2E
P 8900 8700
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:+3.3VLAN #PWR0106
U 1 1 5CD98F08
P 8900 9100
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG0101
U 1 1 5CD9AD58
P 2900 6600
...
Wire Wire Line
	2900 6700 3500 6700
$Comp
L ESP32-PoE_Rev_E:+3.3VLAN #PWR0107
U 1 1 5CDF4E72
P 8900 7700
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:+3.3V #PWR0108
U 1 1 5D0B798B
P 21300 9600
...
$Comp
L ESP32-PoE_Rev_E:Crystal_GND Q1
U 1 1 5F6FF775
P 3900 14100
...
$Comp
L ESP32-PoE_Rev_E:Fiducial FID4
U 1 1 5FAAF1B6
P 19000 14200
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:Fiducial FID5
U 1 1 5FAAF1BC
P 20400 14200
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:Fiducial FID6
U 1 1 5FAAF1C2
P 21800 14200
...
Wire Wire Line
	3500 4100 3500 3600
$Comp
L ESP32-PoE_Rev_E:BL4054B-42TPRN(SOT23-5) U3
U 1 1 5BC6B942
P 4700 3600
...
NoConn ~ 5200 14100
$Comp
L ESP32-PoE_Rev_E:CH340T(SSOP20W) U1
U 1 1 58D41048
P 4700 13700
...
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG0102
U 1 1 5CB9396F
P 2700 12600
...
$Comp
L ESP32-PoE_Rev_E:D_Schottky_Small D6
U 1 1 5CC49C64
P 6100 13200
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:D_Schottky_Small D7
U 1 1 5CD008F2
P 6100 13300
...
$Comp
L ESP32-PoE_Rev_E:PWR_FLAG #FLG0103
U 1 1 5D0EC642
P 3800 13400
...
Wire Wire Line
	3500 1500 3500 2000
$Comp
L ESP32-PoE_Rev_E:SJ BAT_SENS_E1
U 1 1 5C97030F
P 7700 1500
...
Wire Wire Line
	4300 7100 4300 8500
$Comp
L ESP32-PoE_Rev_E:SJ EN_CT1
U 1 1 5CFB72DB
P 13900 9800
F 0 "EN_CT1" H 13650 9850 50  0000 C CNN
F 1 "Closed" H 14150 9850 50  0000 C CNN
...
$EndComp
$Comp
L ESP32-PoE_Rev_E:SJ EN_CT2
U 1 1 5CFBC231
P 13900 9900
F 0 "EN_CT2" H 13650 9950 50  0000 C CNN
F 1 "Closed" H 14150 9950 50  0000 C CNN
